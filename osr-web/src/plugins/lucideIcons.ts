...
import {
  ...
  Database, DatabaseBackup, Delete, Download, Ellipsis, ExternalLink, Eye, EyeOff,
  ...
  KeyRound, ListChecks, LoaderCircle, Lock, LogOut, MapPin, Maximize,
...
const icons: Record<string, Component> = {
  ...
  'pipette': Pipette,
  'play': Play,
  // MCP 令牌：菜单图标（sys_menu.icon = 'plug'，见 20260794 迁移）与页面上的令牌标识
  'plug': Plug,
  'key-round': KeyRound,
  'plus': Plus,
